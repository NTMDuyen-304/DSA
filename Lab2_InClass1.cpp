//STT: 09 - mssv:22520350
//Full Name: Nguyen Thi My Duyen
//Session In-Class - Exercise 01
//Notes or Remarks: ......
...
int main() {
    ...
    do {
        ...
        switch (choice) {
            case 1: {  // Push several numbers onto the stack
            ...
            case 3:  // Check if the stack is full
                ...
                break;
            case 4: {  // Validate a bracket sequence
            ...
            case 5: {  // Reverse words in a string
